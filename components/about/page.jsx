      ...
      <div className="container mx-auto px-4">
        <div className="text-center md:text-right mb-12">
          ...
          <h2 className="mt-4 text-3xl md:text-4xl font-extrabold tracking-tight text-secondary dark:text-white">
            تاريخ عريق ومستقبل واعد في صناعة الدواجن
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <p className="text-foreground/80 dark:text-gray-300 mb-6 leading-8 text-lg">
              تأسست شركة القديراني برؤية واضحة لتكون الرائدة في مجال الدواجن في سوريا. نفخر بتقديم منتجات عالية الجودة تغطي كافة
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a className="inline-flex items-center gap-2 bg-primary text-secondary font-bold px-6 py-3 rounded-md shadow-lg hover:bg-primary-dark transition-colors" href="#contact">
